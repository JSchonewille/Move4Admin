...
public class OfferAdapter extends BaseAdapter {
    ...
    public OfferAdapter(Context context,ArrayList<Offer> o)
    {
        mContext = context;
        offers =o;
    ...
    public View getView(int i, View ConvertView, ViewGroup viewGroup) {
        ...
        holder.name.setText(Integer.toString(o.getOfferID()));
        if(o.getDescription().length() >20 ) {
            holder.latestMessage.setText(o.getDescription().substring(0, 20) + "...");
        }
        else
        {
            holder.latestMessage.setText(o.getDescription());
        }
